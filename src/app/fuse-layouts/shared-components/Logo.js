...
function Logo({ classes }) {
    return (
        <div className={classNames(classes.root, "flex items-center")}>
            <img style={{ width: '90px' }} className="logo-icon" src="assets/images/logos/plano.png" alt="logo" />
            {/* <Typography className="text-16 ml-8 font-light logo-text">PLANO</Typography> */}
